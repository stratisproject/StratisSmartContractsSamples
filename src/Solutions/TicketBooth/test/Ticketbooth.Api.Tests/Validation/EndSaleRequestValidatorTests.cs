...
{
    public class EndSaleRequestValidatorTests
    {
        private EndSaleRequestValidator _validator;

        [SetUp]
        public void SetUp()
        {
            _validator = new EndSaleRequestValidator(new SmartContractTransactionRequestValidator(Mock.Of<Network>()));
        }
