...
{
    public class ReserveTicketRequestValidatorTests
    {
        private ReserveTicketRequestValidator _validator;

        [SetUp]
        public void SetUp()
        {
            _validator = new ReserveTicketRequestValidator(new SmartContractTransactionRequestValidator(Mock.Of<Network>()));
        }
